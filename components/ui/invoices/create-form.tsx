  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <UserCircleIcon className="pointer-events-none absolute left-3 top-1/2 size-5 -translate-y-1/2 text-gray-500" />
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              ...
              />
              <CurrencyDollarIcon className="pointer-events-none absolute left-3 top-1/2 size-5 -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button2 type="submit">Create Invoice</Button2>
      </div>
    </form>
  );
}
